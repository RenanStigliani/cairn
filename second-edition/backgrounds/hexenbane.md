...
|       |                                                                                                                                                                                                                                                                                                                                         |
| ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1** | **Honestidade**. Escolha um **tipo de arma** (contundente, lâmina, etc). Qualquer ataque contra você deste tipo é _prejudicado_. Se o seu voto for quebrado, você perde d4 VON.                                                                                                                                                         |
| **2** | **Pobreza**. Você carrega o **Grimório** _Desmontar_. Apenas você pode usá-lo. Se o seu voto for quebrado, ele explode (d12 dano de FOR). Desmontar: Qualquer parte do seu corpo pode ser destacada e recolocada à vontade, sem causar dor ou dano. Você ainda pode controlá-las. _Regenera quaisquer páginas rasgadas ou danificadas._ |
...
| **6** | **Valor**. A primeira vez que você infligir **Dano Crítico**, você recebe +d4 PG, retornando ao limite anterior no final do combate. Se o seu voto for quebrado, você morre.                                                                                                                                                            |
