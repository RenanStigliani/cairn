...
- O custo da exploração de masmorra é pago em turnos. Se o grupo passar muito tempo em um lugar, agir sem cautela, fizer barulho ou entrar em uma nova área, eles arriscam uma rolagem na tabela de Eventos de Masmorra. Os jogadores devem estar sempre cientes do custo.

## Exemplo de Exploração de Masmorra

Wolfram, Lucius e Freya entraram no primeiro nível de **Ein Eyton**, um templo na floresta que, segundo rumores, abrigava um infame culto da morte. Cada personagem tem uma tocha, mas apenas **Wolfram** está com a dele acesa. Não há fontes de luz aqui além da Lua no céu noturno. A primeira sala é apresentada da seguinte forma:

### O Pátio

Um pátio amplo exposto ao **ar livre**. O **chão** é arenoso e áspero. **Entulho** está empilhado perto do centro da sala. Uma **estátua** em tamanho real segurando um bidente está posicionada no centro exato. Uma **porta** de madeira a Leste está trancada com uma corrente de ferro. Um arco de pedra aberto leva para o Oeste.

- **Ar**: O teto desabou, permitindo que a iluminação externa ilumine a sala.
- **Chão**: Brilha sob a luz. Uma investigação superficial revelará que a "areia" é na verdade ossos pulverizados.
- **Entulho**: Pedaços de pedra de estátuas que lembram pessoas.
  - Uma joia vermelha brilha dentro de um punho de pedra fechado.
- **Estátua**: Uma órbita ocular está vazia, na outra há uma joia vermelha.
  - A Deusa da Morte do culto, desfigurada pelo tempo. Se o olho restante for removido, a estátua ganha vida, fatiando com o bidente em um arco para d6 de dano de FOR. O contato com o bidente transforma a vítima em pedra.
...
**Wolfram**: _"Vou vasculhar a sala em busca de pistas sobre seu propósito, começando por esse chão brilhante."_
...
**Freya**: _"Vou guardar a joia rapidamente na minha mochila."_

**Wolfram**: _"Acho que devemos descer por aquele arco de pedra para o Oeste. Podemos sempre dar a volta e retornar a esta sala na saída."_

**Freya**: _"Espera aí, e essa joia que eu descobri? Parece que ela poderia caber no olho daquela estátua..."_

**Lucius**: _"O que, você ficou maluca? Pelo que sabemos, aquela estátua vai ganhar vida e atacar!"_

**Freya**: _"Ou talvez ela abra uma porta secreta?"_

**Wolfram**: _"Chega, vamos apenas seguir em frente por enquanto. Tem algo do outro lado daquela porta, e eu NÃO quero descobrir o que é!"_

> **O grupo segue para o corredor adjacente e a aventura continua.**
